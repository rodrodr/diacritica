...
import { ExternalLink, FileText, Mic, Monitor, BookOpen, ChevronLeft, ChevronRight, Layers } from 'lucide-react';
...
const categories = ["Todos", "Artículos", "Conferencias", "Otros"];
const ITEMS_PER_PAGE = 6;

export const Publications: React.FC<PublicationsProps> = ({ items, initialCategory = "Todos" }) => {
    ...
    <div className="min-h-screen bg-white pt-32 pb-24">
      ...
      <div className="container mx-auto px-6 mb-16 text-center">
        ...
        <p className="text-gray-500 font-serif italic max-w-2xl mx-auto text-lg">
          Producción académica, actas de conferencias y libros blancos producidos por el grupo de investigación D-IA-Crítica.
        </p>
      </div>
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          {currentItems.map((item) => (
            <div key={item.id} className="group flex flex-col h-full cursor-pointer" onClick={() => handleItemClick(item.url)}>
              {/* Image Container */}
              ...
              <div className="flex-grow flex flex-col items-start">
                ...
                <h3 
                  className="text-2xl font-bold text-brand-dark mb-2 leading-tight group-hover:text-brand-red transition-colors duration-300"
                ...
                <div 
                  className="text-gray-500 font-serif text-sm leading-relaxed mb-6"
                ...
                <div className="mt-auto pt-4 border-t border-gray-100 w-full flex justify-between items-center text-sm font-bold text-brand-dark uppercase tracking-wider">
                   <div 
                     className="group-hover:translate-x-2 transition-transform duration-300 italic font-serif text-gray-600 group-hover:text-brand-dark"
